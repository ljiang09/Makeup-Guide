...
//import UIKit
//
//class tempARManager: NSObject, ObservableObject {
...
//    /// slightly left, very left, slightly right, very right
//
...
//
//        let announcement: String = "Follow the voiceover prompts. Point the front facing camera towards your face. Hold or prop up your phone at about arms length for best results. Now, we will take pictures of your face at different angles to represent what your face looks like without makeup on. This will later be compared to your face after you apply makeup, to check where the makeup is on your face. Start by moving your face around until it is centered in the screen."
...
//
//            // now check until face is centered in the screen
...
//                        self.collectSlightlyLeft() {
//                            self.collectLeft() {
//                                self.collectSlightlyRight() {
//                                    self.collectRight() {
//                                        print("done")
//                                    }
//                                }
...
//                    self.soundHelper.latestAnnouncement = announcement
//                }
//            case self.imageCollectionOptions[0]:
//                // TODO: fill this out
//                print("fill this out!")
//            default:
//                // TODO: fill this out
